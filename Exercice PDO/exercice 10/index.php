...
} elseif (isset($_GET['CountArticle'])) {
        include 'view/countArticles.php';
} elseif (isset($_GET['showArticleId'])) {
        include 'view/viewArticleById.php';}
    elseif (isset($_GET['ChangementTitre'])) {
         include 'view/updateTitle.php';}
